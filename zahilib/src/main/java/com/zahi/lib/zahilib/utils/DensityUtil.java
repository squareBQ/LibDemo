...
public class DensityUtil {
    ...
    public static int dip2sp(Context c, float dpValue) {
        return (int) TypedValue.applyDimension(1, dpValue, c.getResources().getDisplayMetrics());
    }
    ...
    public static int sp2dip(Context c, float spValue) {
        return (int) TypedValue.applyDimension(2, spValue, c.getResources().getDisplayMetrics());
    }
    ...
    public static int getScreenRealH(Context context) {
        @SuppressLint("WrongConstant") WindowManager winMgr = (WindowManager) context.getSystemService("window");
